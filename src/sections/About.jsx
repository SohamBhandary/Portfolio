    ...
    <section className="c-space section-spacing" id="about">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1">
          ...
          />
          <div className="z-10">
            <p className="headtext">Hi, Soham Bhandary</p>
            <p className="subtext">
              MCA fresher aspiring to start my career in software engineering, with a strong focus on Java backend development.
            </p>
          </div>
